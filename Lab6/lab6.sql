...
insert into students values (03456789, 'Porter', 'Harry', 'cs_phx', 23581234, 10.50, 'COMP',to_date('03-9月-07','DD-MON-YY'));
insert into students values (05456789, 'Da Vinci', 'Leonardo', 'cs_dvl', 23585678, 12.00, 'COMP', to_date('01-9月-08','DD-MON-YY'));
insert into students values (03456789, 'Greenleaf', 'Legolas', 'ma_glx', 23582468, 9.12, 'MATH',to_date('02-9月-09','DD-MON-YY'));
insert into students values (04567890, NULL, 'Ceaser', 'ee_cxx', 23589876, 8.34, 'ELEC', to_date('02-9月-09','DD-MON-YY'));
insert into students values (99987654, 'Lazy', 'Lazy', 'lz_llx', 23581357, 2.55, 'LAZY', to_date('01-9月-00','DD-MON-YY'));
insert into students values (11567890, 'Lam', 'Alex', 'lamngok', 23589876, 9.00, 'ELEC', to_date('03-9月-09','DD-MON-YY'));
