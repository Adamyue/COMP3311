...
insert into students values (03456789, 'Porter', 'Harry', 'cs_phx', 23581234, 10.50, 'COMP','03-9月-07', 'COMP231');
insert into students values (05456789, 'Da Vinci', 'Leonardo', 'cs_dvl', 23585678, 12.00, 'COMP', '01-9月-08','COMP231');
insert into students values (03456789, 'Greenleaf', 'Legolas', 'ma_glx', 23582468, 9.12, 'MATH','02-9月-09', 'ELEC214');
insert into students values (04567890, NULL, 'Ceaser', 'ee_cxx', 23589876, 8.34, 'ELEC', '03-9月-09','MATH246');
insert into students values (99987654, 'Lazy', 'Lazy', 'lz_llx', 23581357, 2.55, 'LAZY', '01-9月-00',NULL);
